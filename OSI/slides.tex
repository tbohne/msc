...
\begin{frame}
  ...
  \centering
  Sim. Problemfälle: \O $\thinspace \boldsymbol{13.75}$ / Erwartete Reaktion: \O $\thinspace \boldsymbol{95.89 \%}$\linebreak
  \centering
  Zurückgelegte Distanz: \O $\thinspace \boldsymbol{967.1 m}$
\end{frame}
