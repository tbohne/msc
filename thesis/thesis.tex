...
So far, there has been a focus on indoor environments (TODO: check - is that so?). Despite the obvious challenges that indoor environments pose, they are arguably less dangerous and
