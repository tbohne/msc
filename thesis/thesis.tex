...
is a path to the navigation goal, but \code{move\_base\_flex} cannot find it (cf. fig. \ref{fig:nav_fail}). In fig. \ref{fig:nav_fail}, \code{move\_base\_flex} comes up with a path
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
...
When simulating such a situation, the point farthest from the robot's current position is chosen, which does not guarantee navigation problems, but is a fairly good heuristic.
\begin{figure}[H]
    \centering
