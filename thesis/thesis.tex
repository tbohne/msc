...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{pics/container_model.png}
    \caption{\textsc{TODO: Base Station Model}}
...
the operation state machine, which is responsible for the action execution. Essentially, two of the available actions are extended: \code{return\_to\_base} and \code{charge}. First,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{pics/docking_smach.png}
    \caption{\textsc{TODO: Docking State Machine}}
...
intersections of the final set of candidate lines that could represent the container, it can be verified that there must be two segments that exactly satisfy the container width and
...
TODO: can be easily activated / deactivated in the config - either use docking + container or simplified charging patch without docking.
