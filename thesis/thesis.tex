...
The result of a successful detection is depicted in fig. \ref{fig:detection_success} where the four blue boxes represent the corners of the detected recognized container shape.
\begin{figure}[H]
    \centering
