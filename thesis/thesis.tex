...
pose. The barrier height $b_h \in \mathbb{R}$ and the distance $b_d \in \mathbb{R}$ to the robot are the same four all four and configurable by the user. Moreover, the roll $\phi$
