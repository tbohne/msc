...
as this depends on the situation and environment, but generally one of the two solutions will be triggered and initiate resolution. Undocking errors are in principle not very diverse,
...
this case is simulated, the actual execution of the simulation does not follow immediately after initiation, but waits until the next \code{charge} action indicated by the operation
