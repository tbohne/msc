...
to autonomously drive to specified locations and record scans.\newline
...
Several laser scanners are attached to its base and used to avoid collisions. For the actual task of plant monitoring, a high-resolution 3D-Lidar sensor is used, 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{pics/AROX.png}
    \caption{\textsc{AROX System} (TODO: add img source)}
