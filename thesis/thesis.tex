...
$> 32$\textdegree{}C in the sun. A further example could be that the robot always has a failure after passing a certain waypoint. To determine this, it would be necessary to always
...
used in this thesis. For this purpose, a \code{data\_accumulator} node was written to capture the relevant data during LTA missions and store it in the database. The path for the
