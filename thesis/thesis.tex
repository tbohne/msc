...
the docking resolution and later compared with the most recent state on \code{/arox/battery\_param}. The undocking resolution cout is reset when \code{move\_base\_flex} reports
