...
\begin{itemize}
    ...
    \item empty list of range values \textrightarrow \code{/toggle\_simulated\_ranges\_failure}
    \item look to the sky \textrightarrow \code{/toggle\_simulated\_look\_to\_sky\_failure}
    \item repeated scan \textrightarrow \code{/toggle\_simulated\_repeat\_failure}\newline
\end{itemize}
