...
\ref{sec:sim_and_mon_internet_connection_problems}) and GPS (\ref{sec:sim_and_mon_gps_connection_problems}) connection problems (cf. \ref{sec:sim_and_mon_wifi_connection_problems}),
...
\subsubsection{GPS Connection Failures}
\label{sec:sim_and_mon_gps_connection_problems}
