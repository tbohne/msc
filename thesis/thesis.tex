...
can be observed from fig. \ref{fig:nav_fail_gazebo}, there is a viable route that would accomplish this. In some cases, \code{move\_base\_flex} may find the viable route after a while,
