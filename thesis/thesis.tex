...
All these scenarios are predefined in the \code{ObstacleSpawner} configuration and can be spawned arbitrarily during a robot operation. The number plate on the ground always indicates
