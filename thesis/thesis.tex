...
The idea is to have monitoring nodes that look for the specific types of issues and initiate an appropriate response, i.e. solve the problem or
request the help of a human operator.\newline
