...
classify the identified problems in the simulation according to their severity, i.e., which LTA problem can lead to which worst-case outcome (\code{CONTINGENCY} / \code{CATASTROPHE}).
...
publishing on \code{/sim\_power\_management\_contingency}, the battery discharge rate is increased without the robot noticing, so it simply runs out of battery and normal operation
