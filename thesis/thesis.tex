...
Furgale et al. \cite{Furgale:2010} present a mobile robotic system capable of long-term autonomous operation in a dynamic outdoor environement based on a visual teach-and-repeat
...
environment (cf. \ref{sec:challenges_for_lta}).\newline
...
\cite{Meeussen:2011} For the Meeussen et al., this is another motivation for including a human operator as a fallback solution. Their key insight for this thesis is the importance of having
...
Tipaldi et al. \cite{Tipaldi:2013} introduce a probabilistic localization framework for long-term autonomous systems, particularly acknowledging environement changes during
long-term operations. They state that previous approaches to localization in dynamic environements often treated dynamic objects as outliers and that this is insufficient
for semi-static objects that are naturally part of such environements.\newline
...
artificial intelligence and robotics technologies necessary to create a long-term autonomous mobile service robot in a care facility environement. Thus, it is again an example for a project
...
Even more recently, Kyberd et al. \cite{Kyberd:2021} presented their work on long-term autonomy in diverse outdoor environements. They emphasize that the focus in the literature to date
