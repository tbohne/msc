...
Since problematic values can depend heavily on the environment and application scenario, these values are configurable by the user.
...
unusable. \cite{metageek} Thus, a signal level failure is simulated by publishing an RSSI value of $-90$ dBm.\newline
