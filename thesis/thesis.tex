...
motion for the odometry can be simulated by publishing a linear twist on \code{cmd\_vel} to let the robot move slightly. Practically, both cases may refer to situations where the
...
active navigation goal is being pursued, otherwise the motion would be expected.
