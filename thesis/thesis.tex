...
TODO: paragraph should be refined\newline
...
In the following, potential ways of simulating each issue in order to evaluate it are discussed as well as monitoring solutions.
