...
The rapidly growing human population and environmental changes require a significant increase in production to meet rising demand. \cite{Virlet:2016}\newline
...
An early example of a long-term autonomous mobile service robot is \textit{RHINO}, an interactive museum tour guide developed by Burgard et al. \cite{Burgard:1998}
...
genetic research. \cite{Bayati:2018} The authors claim that in 2018, there were no commercially available high-throughput plant phenotyping (HTP) platforms and especially no
...
\cite{Latif:2018} These versions can then be used to learn how to distinguish locations.
