...
select the problems to be considered in this work, i.e. those for which monitoring methods are presented that do not necessarily solve $100\%$ of the potential cases, a certain
fraction, at least to a first approximation. In addition, more fundamental problems are emphasized that cannot be addressed in general within the scope of this work; perhaps special
