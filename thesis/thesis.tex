...
In total, there are $48$ specifically addressed problem cases that are identified through monitoring and resolved or communicated accordingly, but many more are implicitly covered. e.g...
The cases are not all strictly separated from each other, the transitions are sometimes fluid.
