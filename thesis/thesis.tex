...
Essentially, any navigation framework that is compatible with the general \code{actionlib\_msgs/GoalStatus} should be compatible with the introduced monitoring solution.
\newline
