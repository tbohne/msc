...
\noindent
It would be beyond the scope of this work to tackle every identified potential challenge for a mobile robot's long-term autonomy. Therefore, it is necessary to sort the list and
select the problems to be solved in this work, i.e., those detected by the presented monitoring methods, at least to a first approximation, that do not solve $100\%$ of the potential
cases, but do solve a certain proportion. In addition, more fundamental problems are emphasized that cannot be addressed generally within the scope of this work; perhaps special
