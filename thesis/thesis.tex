...
the three challenges are considered together under the heading of \textit{Navigation Failure}.\newline

\noindent
\textit{Obstacles Blocking the Planned Path}\newline
