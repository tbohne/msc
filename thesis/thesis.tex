...
(cf. section \ref{sec:}), a high quality is assumed for this component because if this were not the case, it would already have been detected by the corresponding connection
