...
troublesome than outdoor scenarios. \cite{Hawes:2017}\newline
...
that have been identified as critical to successful long-term autonomous deployment (cf. \ref{sec:challenges_for_lta}). As Hawes et al. put it: \textquote{A key strategy for
...
the interest of safety. \cite{Furgale:2015}
