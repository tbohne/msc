...
by setting $s_v = 3$. The simulation of the remaining extreme weather events can be triggered analogously and can be activated / deactivated via the following ROS topics:
\begin{itemize}
