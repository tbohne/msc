...
With regard to the reliable use of long-term autonomous robots in real-world environments, many challenges still need to be overcome.
Kunze et al. identify several such future challenges. One of them, considered in this work, is the design of ``human-in-the-loop'' systems that are able 
to utilize the help of human operators in unexpected problematic situations. \cite{Kunze:2018}
