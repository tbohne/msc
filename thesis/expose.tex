...
drive to specified locations and record scans.
...
The starting point of the work will be a physics simulation in Gazebo\footnote{Open-source 3D robotics simulator} that has been created within the research project 
PORTAL\footnote{https://www.dfki.de/web/forschung/projekte-publikationen/projekte-uebersicht/projekt/portal/} and will be adapted and extended as part of this work.
